...
public class Main {
    public static void main(String[] args) {
        ...
        House houseTwo = new House("your house", "December 1, 2016", 18221, "89 Fake Rd", 197, 232);
        ...
        houseOne.getCondition();
        houseTwo.getCondition();
